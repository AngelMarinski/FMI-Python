...
bg_img = pygame.image.load('Project/img/sky.png')
bg_img = pygame.transform.scale(bg_img, (screen_width, screen_height - margin))
dirt_img = pygame.image.load('Project/img/dirt.png')
grass_img = pygame.image.load('Project/img/grass.png')
blob_img = pygame.image.load('Project/img/blob.png')
platform_x_img = pygame.image.load('Project/img/platform_x.png')
platform_y_img = pygame.image.load('Project/img/platform_y.png')
lava_img = pygame.image.load('Project/img/lava.png')
coin_img = pygame.image.load('Project/img/coin.png')
exit_img = pygame.image.load('Project/img/exit.png')
save_img = pygame.image.load('Project/img/save_btn.png')
load_img = pygame.image.load('Project/img/load_btn.png')
